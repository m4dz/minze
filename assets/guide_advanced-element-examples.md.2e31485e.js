import{_ as n,c as s,o as a,a as t}from"./app.94d8410b.js";const m='{"title":"Element Examples","description":"","frontmatter":{},"headers":[{"level":2,"title":"Link","slug":"link"},{"level":2,"title":"Input Wrapper","slug":"input-wrapper"},{"level":2,"title":"Persistent Storage","slug":"persistent-storage"}],"relativePath":"guide/advanced-element-examples.md"}',p={},o=t(`<h1 id="element-examples" tabindex="-1">Element Examples <a class="header-anchor" href="#element-examples" aria-hidden="true">#</a></h1><p>Below you can find some advanced examples on how to create certain element functionality with Minze.</p><h2 id="link" tabindex="-1">Link <a class="header-anchor" href="#link" aria-hidden="true">#</a></h2><p>Recreating some basic functionality of the <code>&lt;a&gt;&lt;/a&gt;</code> link element with Minze.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token keyword">import</span> Minze<span class="token punctuation">,</span> <span class="token punctuation">{</span> MinzeElement <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
