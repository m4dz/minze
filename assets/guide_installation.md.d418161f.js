...
</code></pre></div><h2 id="cli" tabindex="-1">CLI <a class="header-anchor" href="#cli" aria-hidden="true">#</a></h2><p>Installing via command line:</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The CLI method scaffolds a Minze Dev and Publishing environment including <code>rollup</code> and <code>vite</code>.</p></div><blockquote><p>Minze requires <a href="https://nodejs.dev/" target="_blank" rel="noopener noreferrer">Node.js</a> version &gt;= <code>14.0.0</code></p></blockquote><p><strong>npm</strong></p><div class="language-bash"><pre><code><span class="token comment"># npm</span>
