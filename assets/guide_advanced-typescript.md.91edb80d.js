import{_ as n,c as s,o as a,a as t}from"./app.94d8410b.js";const y='{"title":"TypeScript","description":"","frontmatter":{},"headers":[],"relativePath":"guide/advanced-typescript.md"}',e={},p=t(`<h1 id="typescript" tabindex="-1">TypeScript <a class="header-anchor" href="#typescript" aria-hidden="true">#</a></h1><p>This section assumes you already have a basic understanding of TypeScript. The process of writing Minze components in TypeScript is similar to writing them in vanilla JavaScript.</p><p>There are some small differences, like using <a href="/api/#type-helpers">Type Helpers</a> and defining types for dynamic properties.</p><p>By going through and understanding the example below, you will have a firm grasp of how to work with Minze components in TypeScript.</p><p><strong>Example</strong></p><div class="language-ts"><pre><code><span class="token comment">/**
 * We are importing the base MinzeElement class
 * plus some tuple-type helpers.
 */</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> MinzeElement<span class="token punctuation">,</span> Reactive<span class="token punctuation">,</span> Attrs<span class="token punctuation">,</span> Watch<span class="token punctuation">,</span> EventListeners <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
...
</code></pre></div>`,8),o=[p];function c(l,i,r,u,k,d){return a(),s("div",null,o)}var h=n(e,[["render",c]]);export{y as __pageData,h as default};
