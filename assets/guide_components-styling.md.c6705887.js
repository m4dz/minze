...
</code></pre></div><h3 id="conditional-styling" tabindex="-1">Conditional Styling <a class="header-anchor" href="#conditional-styling" aria-hidden="true">#</a></h3><p>You can use the <code>ternary</code> operator to conditionally render properties inside <code>css</code>.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token keyword">import</span> Minze<span class="token punctuation">,</span> <span class="token punctuation">{</span> MinzeElement <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,46),o=[p];function c(l,i,u,k,r,d){return a(),s("div",null,o)}var h=n(e,[["render",c]]);export{m as __pageData,h as default};
